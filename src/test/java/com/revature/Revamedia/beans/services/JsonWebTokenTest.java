...
public class JsonWebTokenTest {
    ...
    @Test
    public void verifyReturnsCookieDto(@Autowired JsonWebToken jsonWebToken) throws JsonProcessingException{
        jsonWebToken.setConfig(objectMapperMock);
    ...
    @Test
    public void verifyThrowsUnauthorizedUserException(@Autowired JsonWebToken jsonWebToken) throws JsonProcessingException {
        jsonWebToken.setConfig(objectMapperMock);
        jsonWebToken.setVerifier(verifierMock);
        String jwt = "312009802398023";
        CookieDto cookieDto = new CookieDto(USER_1);
        ...
        assertThrows(UnauthorizedUserException.class, () -> jsonWebToken.verify(jwt));
