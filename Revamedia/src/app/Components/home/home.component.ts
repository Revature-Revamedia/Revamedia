...
export class HomeComponent implements OnInit {
  ...
  constructor(public router: Router, public CommentService: CommentService, private userPostsService: UserPostsService, private http: HttpClient, public userService: UserService, public gifService: GiphyService, public animationService: AnimationService) { }
