 ...
 * context.getBean(UserFollowsService.class);
 * // KYLE
 * User kyle = new User();
 ...
 * );
 * post1.
 * setMessage("I Still can't believe i was able to see this view in person.");
 ...
 * post2.setImage(
 * "https://images.pexels.com/photos/3601450/pexels-photo-3601450.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2"
 * );
 ...
 * post3.setImage(
 * "https://images.pexels.com/photos/5750823/pexels-photo-5750823.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2"
 * );
 * post3.
 * setMessage("This week i am going to start training in a boxing gym. I hope i can get better at self defense."
 * );
